...
class Earnings extends Component{
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:8082/api/v1/reservation/RideHistory/'+ driverId) 
        .then(response => {
...
<section className="formheader">
                        <h4 style={{paddingLeft:"50px"}}>Earnings Details</h4>
                </section>
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                ...
                                <tr key={ride.reservationId}>
                                    ...
                                    <td>{new Date(ride.reservationDate).toLocaleDateString('en-GB')}</td>                                
                                    <td>{ride.amount}</td>
                                </tr>
                            ))}
                            </tbody>
