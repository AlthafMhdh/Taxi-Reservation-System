...
const PayBookingModal = ({ isOpen, onClose, bookingId, amount }) => {
    ...
    const openDoneModal = () => {
       ...
       bookingId=bookingId
        console.log("Reserve: ",bookingId)
        console.log(bookingId.type)        
        const payData = {
                bookings: bookingId
            };

            axios.put('http://localhost:8082/api/v1/payment/updateBookingPayment', payData)
            .then(response => {
