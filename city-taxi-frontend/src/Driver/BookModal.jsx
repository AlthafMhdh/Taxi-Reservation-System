...
const BookModal = ({ isOpen, onClose, bookingId, pickup, drop, amount }) => {
    ...
    const openPayModal = () => {
        ...
        bookingId=bookingId
        amount={amount}
        console.log("Rese Id :",bookingId)
        console.log(bookingId.type)
    ...
    return (
        ...
        <PayBookingModal isOpen={isPayModalOpen} onClose={closePayModal} bookingId={bookingId} amount={amount} />
